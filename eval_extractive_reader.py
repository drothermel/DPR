...
import maqa_utils.file_utils as fu

logger = logging.getLogger()
setup_logger(logger)

ReaderQuestionPredictions = collections.namedtuple("ReaderQuestionPredictions", ["id", "question", "predictions", "gold_answers"])
...
class ReaderTrainer(object):
    def __init__(self, cfg: DictConfig):
        ...
        ## New stuff
        self.evcf = fu.load_file('/scratch/ddr8143/multiqa/full_pipeline_data_v1/cf_results/qmp_dev_simple.gpt3_move_to_ev_qe_v1_20230429_v1.evcf_filter_cid400_mw100.pkl')
        self.cid_range_dict = fu.load_file('/scratch/ddr8143/multiqa/full_pipeline_data_v1/cf_results/qmp_dev_simple.gpt3_move_to_ev_qe_v1_20230429_v1.tokranges_filter_cid400_mw100.pkl')
        logger.info("****** finished loading evcf and cid_range_dict *********")
    ...
    def _get_best_prediction(
        ...
        for q in range(questions_num):
            ...
            for p in range(passages_per_question):
                ...
                best_spans = get_best_spans_eval(
                    self.tensorizer,
                    p_start_logits,
                    p_end_logits,
                    ctx_ids,
                    ...
                    top_spans=10,
                    evcf=self.evcf,
                    cid_range_dict=self.cid_range_dict,
            ...
            if False:# passage_thresholds:
                ...
                if len(nbest) == 0:
                    ...
                    predictions = {passages_per_question: nbest}
            batch_results.append(ReaderQuestionPredictions(sample.passages[0].id, sample.question, predictions, sample.answers))
